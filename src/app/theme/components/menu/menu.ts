...
export const verticalMenuItems = [ 
  //  new Menu (1, 'Dashboard', '/pages/dashboard', null, 'tachometer', null, false, 0),
   // new Menu (2, 'Users', '/pages/membership', null, 'users', null, false, 0), 
    new Menu (2, 'Admin', 'pages/admin', null, 'admin', null, false, 0),
    new Menu (2, 'Merchant Transactions', 'pages/merchant', null, 'merchant', null, false, 0),
    new Menu (2, 'Clients Transactions', 'pages/client', null, 'merchant', null, false, 0),
  //  new Menu (3, 'UI Features', null, null, 'laptop', null, true, 0),   
   ...
   //new Menu (26, 'Clients', null, null, 'table', null, true, 0),
   //new Menu (27, 'Basic Tables', '/pages/tables/basic-tables', null, 'th', null, false, 26), 
    new Menu (28, 'Details', null, null, 'th-large', null, true, 26), 
    new Menu (29, ' DataTable', '/pages/tables/dynamic-tables/smart', null, 'caret-right', null, false, 28),
